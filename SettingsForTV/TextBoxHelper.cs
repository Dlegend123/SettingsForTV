...
public static class TextBoxHelper
{
    ...
    {
        return (NumericFormat)element.GetValue(OnlyNumericProperty);
    }
    ...
    public static string GetDefaultValue(TextBox element)
    {
    ...
    {
        return (EvenOddConstraint)element.GetValue(EvenOddConstraintProperty);
    }
    ...
    private static void TextBox_PreviewTextInput(object sender, TextCompositionEventArgs e)
    {
        ...
        switch (GetOnlyNumeric(textBox))
        {
            ...
            {
                if (int.TryParse(newText, out var number))
                    switch (evenOddConstraint)
                    {
                        case EvenOddConstraint.OnlyEven:
            ...
            {
                if (uint.TryParse(newText, out var number))
                    switch (evenOddConstraint)
                    {
                        case EvenOddConstraint.OnlyEven:
    ...
    private static void TextBox_TextChanged(object sender, TextChangedEventArgs e)
    {
        ...
        switch (GetOnlyNumeric(textBox))
        {
            ...
            case NumericFormat.Uint:
            {
                if (uint.TryParse(textBox.Text, out var number))
                    switch (evenOddConstraint)
                    {
                        case EvenOddConstraint.OnlyEven:
            ...
            case NumericFormat.Natural:
            {
                ...
                e.Handled = regex.IsMatch(textBox.Text);
